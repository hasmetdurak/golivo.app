...
export const translations: Record<string, Translations> = {
  ...
  tl: {
    ...
    today: 'Ngayon', homeTeam: 'Tahanan', awayTeam: 'Away', halfTime: 'Unang Half',
    ...
    liveMatch: 'LIVE', matchesCount: 'LABAN', appTitle: 'Mga Live Football Scores', todaysMatches: 'Mga Laban Ngayon'
  },
  sw: {
  ...
  ak: { 
    ...
    awayTeam: 'Ɛhɔhoɔ', 
    halfTime: 'Fa berɛ', 
    matchEvents: 'Agorɔ nsɛm', 
    matchDetails: 'Agorɔ ho nsɛm', 
    statistics: 'Agorɔ akontaabu', 
    close: 'To mu', 
    noMatches: 'Wɔanhu agorɔ biara', 
    checkLater: 'San bra hwɛ nnɛɛma foforɔ', 
    liveMatch: 'SƐ ƐREKƆ', 
    matchesCount: 'AGORƆ', 
    appTitle: 'Agorɔ Ɛrekɔ Scores', 
    todaysMatches: 'Ɛnnɛ AgorƆ' 
  },
  gn: { 
    live: 'KOÃGÃ', 
    finished: 'Opambáma', 
    ...
    awayTeam: 'Ohóva', 
    halfTime: 'Mbytepyte', 
    matchEvents: 'Ñembosar̃ai rembiasakue', 
    matchDetails: 'Ñembosar̃ai marandu', 
    statistics: 'Ñembosar̃ai estadística', 
    close: 'Mboty', 
    noMatches: 'Ndojejuhái ñembosar̃ai', 
    checkLater: 'Ejujey uperire ñemoĩporã', 
    liveMatch: 'KOÃGÃ', 
    matchesCount: 'ÑEMBOSAR̃AI', 
    appTitle: 'Mangapu Ñembosar̃ai Koãgã', 
    todaysMatches: 'Ko árape Ñembosar̃ai' 
  },
